...
export class JobMySuffixComponent implements OnInit {
  jobs?: IJobMySuffix[];
  isLoading = false;
  totalItems = 0;
  ...
  trackId(index: number, item: IJobMySuffix): string {
    return item.id!;
  }
  ...
  protected onSuccess(data: IJobMySuffix[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
